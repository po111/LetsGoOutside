        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Author identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, comment: "Author Name"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Organizer identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false, comment: "Organizer Name"),
                    PhoneNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: false, comment: "Organizer's phone"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false, comment: "User Identifier"),
                    DateOfCreation = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Organizer date of creation")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, comment: "Article Identifier")
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Title = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false, comment: "Article title"),
                    Content = table.Column<string>(type: "nvarchar(max)", maxLength: 5000, nullable: false, comment: "Article content"),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date of creation"),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date modified"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Article image url"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false, comment: "Event description"),
                    Address = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false, comment: "Event address"),
                    DateOfCreation = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date of creation of event"),
                    DueDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Date of event"),
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true, comment: "Event image url"),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ArticlesId = table.Column<int>(type: "int", nullable: false),
                    WeathersId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleWeather", x => new { x.ArticlesId, x.WeathersId });
                    table.ForeignKey(
                        name: "FK_ArticleWeather_Articles_ArticlesId",
                        column: x => x.ArticlesId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleWeather_Weathers_WeathersId",
                        column: x => x.WeathersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleWeather_WeathersId",
                table: "ArticleWeather",
                column: "WeathersId");
